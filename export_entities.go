...
type ClickEvent struct {
	...
	DiMatchClickToken                                  string `csv:"di_match_click_token" json:"di_match_click_token"`
	...
	EventTimestamp                                     string `csv:"event_timestamp" json:"event_timestamp"`
...
type EcommerceEvent struct {
	id                                                        string `csv:"" json:""`
	name                                                      string `csv:"" json:""`
	timestamp                                                 string `csv:"" json:""`
	timestamp_iso                                             string `csv:"" json:""`
	origin                                                    string `csv:"" json:""`
	last_attributed_touch_type                                string `csv:"" json:""`
	last_attributed_touch_timestamp                           string `csv:"" json:""`
	last_attributed_touch_timestamp_iso                       string `csv:"" json:""`
	last_attributed_touch_data_tilde_id                       string `csv:"" json:""`
	last_attributed_touch_data_tilde_campaign                 string `csv:"" json:""`
	last_attributed_touch_data_tilde_campaign_id              string `csv:"" json:""`
	last_attributed_touch_data_tilde_channel                  string `csv:"" json:""`
	last_attributed_touch_data_tilde_feature                  string `csv:"" json:""`
	last_attributed_touch_data_tilde_stage                    string `csv:"" json:""`
	last_attributed_touch_data_tilde_tags                     string `csv:"" json:""`
	last_attributed_touch_data_tilde_advertising_partner_name string `csv:"" json:""`
	last_attributed_touch_data_tilde_secondary_publisher      string `csv:"" json:""`
	last_attributed_touch_data_tilde_creative_name            string `csv:"" json:""`
	last_attributed_touch_data_tilde_creative_id              string `csv:"" json:""`
	last_attributed_touch_data_tilde_ad_set_name              string `csv:"" json:""`
	last_attributed_touch_data_tilde_ad_set_id                string `csv:"" json:""`
	last_attributed_touch_data_tilde_ad_name                  string `csv:"" json:""`
	last_attributed_touch_data_tilde_ad_id                    string `csv:"" json:""`
	last_attributed_touch_data_tilde_branch_ad_format         string `csv:"" json:""`
	last_attributed_touch_data_tilde_technology_partner       string `csv:"" json:""`
	last_attributed_touch_data_tilde_banner_dimensions        string `csv:"" json:""`
	last_attributed_touch_data_tilde_placement                string `csv:"" json:""`
	last_attributed_touch_data_tilde_keyword_id               string `csv:"" json:""`
	last_attributed_touch_data_tilde_agency                   string `csv:"" json:""`
	last_attributed_touch_data_tilde_optimization_model       string `csv:"" json:""`
	last_attributed_touch_data_tilde_secondary_ad_format      string `csv:"" json:""`
	last_attributed_touch_data_tilde_journey_name             string `csv:"" json:""`
	last_attributed_touch_data_tilde_journey_id               string `csv:"" json:""`
	last_attributed_touch_data_tilde_view_name                string `csv:"" json:""`
	last_attributed_touch_data_tilde_view_id                  string `csv:"" json:""`
	last_attributed_touch_data_plus_current_feature           string `csv:"" json:""`
	last_attributed_touch_data_plus_via_features              string `csv:"" json:""`
	last_attributed_touch_data_dollar_3p                      string `csv:"" json:""`
	last_attributed_touch_data_plus_web_format                string `csv:"" json:""`
	last_attributed_touch_data_custom_fields                  string `csv:"" json:""`
	days_from_last_attributed_touch_to_event                  string `csv:"" json:""`
	hours_from_last_attributed_touch_to_event                 string `csv:"" json:""`
	minutes_from_last_attributed_touch_to_event               string `csv:"" json:""`
	seconds_from_last_attributed_touch_to_event               string `csv:"" json:""`
	last_cta_view_timestamp                                   string `csv:"" json:""`
	last_cta_view_timestamp_iso                               string `csv:"" json:""`
	last_cta_view_data_tilde_id                               string `csv:"" json:""`
	last_cta_view_data_tilde_campaign                         string `csv:"" json:""`
	last_cta_view_data_tilde_campaign_id                      string `csv:"" json:""`
	last_cta_view_data_tilde_channel                          string `csv:"" json:""`
	last_cta_view_data_tilde_feature                          string `csv:"" json:""`
	last_cta_view_data_tilde_stage                            string `csv:"" json:""`
	last_cta_view_data_tilde_tags                             string `csv:"" json:""`
	last_cta_view_data_tilde_advertising_partner_name         string `csv:"" json:""`
	last_cta_view_data_tilde_secondary_publisher              string `csv:"" json:""`
	last_cta_view_data_tilde_creative_name                    string `csv:"" json:""`
	last_cta_view_data_tilde_creative_id                      string `csv:"" json:""`
	last_cta_view_data_tilde_ad_set_name                      string `csv:"" json:""`
	last_cta_view_data_tilde_ad_set_id                        string `csv:"" json:""`
	last_cta_view_data_tilde_ad_name                          string `csv:"" json:""`
	last_cta_view_data_tilde_ad_id                            string `csv:"" json:""`
	last_cta_view_data_tilde_branch_ad_format                 string `csv:"" json:""`
	last_cta_view_data_tilde_technology_partner               string `csv:"" json:""`
	last_cta_view_data_tilde_banner_dimensions                string `csv:"" json:""`
	last_cta_view_data_tilde_placement                        string `csv:"" json:""`
	last_cta_view_data_tilde_keyword_id                       string `csv:"" json:""`
	last_cta_view_data_tilde_agency                           string `csv:"" json:""`
	last_cta_view_data_tilde_optimization_model               string `csv:"" json:""`
	last_cta_view_data_tilde_secondary_ad_format              string `csv:"" json:""`
	last_cta_view_data_plus_via_features                      string `csv:"" json:""`
	last_cta_view_data_dollar_3p                              string `csv:"" json:""`
	last_cta_view_data_plus_web_format                        string `csv:"" json:""`
	last_cta_view_data_custom_fields                          string `csv:"" json:""`
	deep_linked                                               string `csv:"" json:""`
	first_event_for_user                                      string `csv:"" json:""`
	user_data_os                                              string `csv:"" json:""`
	user_data_os_version                                      string `csv:"" json:""`
	user_data_model                                           string `csv:"" json:""`
	user_data_browser                                         string `csv:"" json:""`
	user_data_geo_country_code                                string `csv:"" json:""`
	user_data_app_version                                     string `csv:"" json:""`
	user_data_sdk_version                                     string `csv:"" json:""`
	user_data_geo_dma_code                                    string `csv:"" json:""`
	user_data_environment                                     string `csv:"" json:""`
	user_data_platform                                        string `csv:"" json:""`
	user_data_aaid                                            string `csv:"" json:""`
	user_data_idfa                                            string `csv:"" json:""`
	user_data_idfv                                            string `csv:"" json:""`
	user_data_android_id                                      string `csv:"" json:""`
	user_data_limit_ad_tracking                               string `csv:"" json:""`
	user_data_user_agent                                      string `csv:"" json:""`
	user_data_ip                                              string `csv:"" json:""`
	user_data_developer_identity                              string `csv:"" json:""`
	user_data_language                                        string `csv:"" json:""`
	user_data_brand                                           string `csv:"" json:""`
	di_match_click_token                                      string `csv:"" json:""`
	event_data_revenue_in_usd                                 string `csv:"" json:""`
	event_data_exchange_rate                                  string `csv:"" json:""`
	event_data_transaction_id                                 string `csv:"" json:""`
	event_data_revenue                                        string `csv:"" json:""`
	event_data_currency                                       string `csv:"" json:""`
	event_data_shipping                                       string `csv:"" json:""`
	event_data_tax                                            string `csv:"" json:""`
	event_data_coupon                                         string `csv:"" json:""`
	event_data_affiliation                                    string `csv:"" json:""`
	event_data_search_query                                   string `csv:"" json:""`
	event_data_description                                    string `csv:"" json:""`
	custom_data                                               string `csv:"" json:""`
	last_attributed_touch_data_tilde_keyword                  string `csv:"" json:""`
	user_data_cross_platform_id                               string `csv:"" json:""`
	user_data_past_cross_platform_ids                         string `csv:"" json:""`
	user_data_prob_cross_platform_ids                         string `csv:"" json:""`
	store_install_begin_timestamp                             string `csv:"" json:""`
	referrer_click_timestamp                                  string `csv:"" json:""`
	user_data_os_version_android                              string `csv:"" json:""`
	user_data_geo_city_code                                   string `csv:"" json:""`
	user_data_geo_city_en                                     string `csv:"" json:""`
	user_data_http_referrer                                   string `csv:"" json:""`
	event_timestamp                                           string `csv:"" json:""`
	customer_event_alias                                      string `csv:"" json:""`
	last_attributed_touch_data_tilde_customer_campaign        string `csv:"" json:""`
	last_attributed_touch_data_tilde_campaign_type            string `csv:"" json:""`
	last_cta_view_data_tilde_campaign_type                    string `csv:"" json:""`
	last_attributed_touch_data_tilde_agency_id                string `csv:"" json:""`
	last_attributed_touch_data_plus_touch_id                  string `csv:"" json:""`
	last_cta_view_data_plus_touch_id                          string `csv:"" json:""`
	user_data_installer_package_name                          string `csv:"" json:""`
	user_data_cpu_type                                        string `csv:"" json:""`
	user_data_screen_width                                    string `csv:"" json:""`
	user_data_screen_height                                   string `csv:"" json:""`
	user_data_build                                           string `csv:"" json:""`
	user_data_internet_connection_type                        string `csv:"" json:""`
	hash_version                                              string `csv:"" json:""`
}
